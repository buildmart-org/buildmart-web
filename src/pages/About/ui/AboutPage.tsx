    ...
    <div className={styles.wrapper}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.block}>
          ...
          <p>
            Our mission is simple: to provide exceptional products, outstanding
            customer service, and a seamless shopping experience. Whether you're
            a tech enthusiast or just looking for reliable electronics, we're
      ...
      <section className={styles.section}>
        ...
        <div className={styles.values}>
          <div className={styles.card}>
            ...
            <h3>Quality First</h3>
            <p>
              We only stock products from trusted brands that meet our rigorous
              quality standards.
            </p>
          </div>
          ...
          <div className={styles.card}>
            ...
            <h3>Fast & Reliable</h3>
            <p>
              Quick shipping, easy returns, and responsive support — we're here
              when you need us.
            </p>
          </div>
        </div>
